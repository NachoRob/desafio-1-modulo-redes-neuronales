...
La curva ROC muestra la capacidad del modelo para distinguir entre clientes que abandonan y clientes que permanecen.

![Curva ROC AUC](images/roc_curve.png)

**AUC = 0.91**, lo que indica una excelente capacidad predictiva.
